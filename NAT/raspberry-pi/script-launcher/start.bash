...
rc-update add sshd
echo "n" | ssh-keygen -t rsa -b 4096 -f /home/user/.ssh/raspberry_rsa -N ""
...
ssh -Nfvvvv -R "$PORT:localhost:22" g3@212.83.130.156 -i /home/user/.ssh/id_rsa -o StrictHostKeyChecking=no
